...
package com.theone.cachemanager.encrypt.ext

import com.theone.cachemanager.encrypt.GenKey
...
fun String.md5(salt: String = ""): String =
    hashFunc(ENCRYPT_MD5, this + salt)
 ...
 */
fun File.md5(): String =
    hashFuncForFile(ENCRYPT_MD5, inputStream())
...
fun String.sha1(): String =
    hashFunc(ENCRYPT_SHA1, this)

/**
 * SHA224加密
 */
fun String.sha224(): String =
    hashFunc(ENCRYPT_SHA224, this)

/**
 * SHA256加密
 */
fun String.sha256(): String =
    hashFunc(ENCRYPT_SHA256, this)

/**
 * SHA384加密
 */
fun String.sha384(): String =
    hashFunc(ENCRYPT_SHA384, this)

/**
 * SHA512加密
 */
fun String.sha512(): String =
    hashFunc(ENCRYPT_SHA512, this)
...
fun String.hmacMD5(key: String): String =
    hmacFunc(this, ENCRYPT_HMAC_MD5, key)
...
fun String.hmacSHA1(key: String): String =
    hmacFunc(this, ENCRYPT_HMAC_SHA1, key)
 ...
 * @param key
 */
fun String.hmacSHA224(key: String): String =
    hmacFunc(this, ENCRYPT_HMAC_SHA224, key)
...
fun String.hmacSHA256(key: String): String =
    hmacFunc(this, ENCRYPT_HMAC_SHA256, key)
 ...
 * @param key
 */
fun String.hmacSHA384(key: String): String =
    hmacFunc(this, ENCRYPT_HMAC_SHA384, key)
...
fun String.hmacSHA512(key: String): String =
    hmacFunc(this, ENCRYPT_HMAC_SHA512, key)
...
fun generateSecretKey(password: String, keySizeInBytes: Int, encryptType: String = ENCRYPT_AES): SecretKey =
        SecretKeySpec(GenKey.getKey(password,keySizeInBytes), encryptType)
...
fun String.encryptAES(password: String, keySizeInBytes: Int = 32, transformation: String = DEFAULT_AES_TRANSFORMATION): String {
    ...
    val result =
        encryptOrDecryptAES(rawKey, this.toByteArray(), transformation, true)
    return result.toHex()
}
...
fun String.decryptAES(password: String, keySizeInBytes: Int = 32, transformation: String = DEFAULT_AES_TRANSFORMATION): String {
    val rawKey = generateSecretKey(password, keySizeInBytes)
    val result =
        encryptOrDecryptAES(rawKey, this.hexToByteArray(), transformation, false)
...
fun String.decryptBase64AES(password: String, keySizeInBytes: Int = 32, transformation: String = DEFAULT_AES_TRANSFORMATION): String {
    val rawKey = generateSecretKey(password, keySizeInBytes)
    val result =
        encryptOrDecryptAES(rawKey, this.base64Decode(), transformation, false)
    return String(result)
}
...
fun String.encryptDES(password: String, transformation: String = DEFAULT_DES_TRANSFORMATION): String {
    val rawKey = generateSecretKey(
        password,
        8,
        ENCRYPT_DES
    )
    val result =
        encryptOrDecryptDES(rawKey, this.toByteArray(), transformation, true)
    return result.toHex()
}
...
fun String.decryptDES(password: String, transformation: String = DEFAULT_DES_TRANSFORMATION): String {
    ...
    val result =
        encryptOrDecryptDES(rawKey, this.hexToByteArray(), transformation, false)
    return String(result)
}
...
fun String.decryptBase64DES(password: String, transformation: String = DEFAULT_DES_TRANSFORMATION): String {
    ...
    val result =
        encryptOrDecryptDES(rawKey, this.base64Decode(), transformation, false)
    return String(result)
}
...
fun String.rsaEncryptByPublicKey(publicKey: ByteArray, transformation: String = DEFAULT_RSA_TRANSFORMATION): ByteArray =
    rsaEncryptOrDecryptByPublicKey(
        this.toByteArray(),
        publicKey,
        true,
        transformation
...
fun String.rsaEncryptByPrivateKey(privateKey: ByteArray, transformation: String = DEFAULT_RSA_TRANSFORMATION): ByteArray =
    rsaEncryptOrDecryptByPrivateKey(
        this.toByteArray(),
        privateKey,
        true,
        transformation
